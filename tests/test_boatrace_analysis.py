...
class TestBoatraceAnalysis(unittest.TestCase):
    ...
    def test_make_flat_row(self):
        ...
        preview_race = {
            ...
            "number": 11,
            "boats": [
                {"racer_boat_number": 2, "racer_course_number": 2, "racer_start_timing": 0.05, "racer_exhibition_time": 682, "racer_tilt_adjustment": "0.0"},
            ],
        }
        row = ba.make_flat_row(result_race, program_race, preview_race, 5100)
